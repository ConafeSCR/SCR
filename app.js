...
const cargarDocumentos = (documentos) => {
	if(documentos.length > 0){
      ...
      <a href="Preescolar.html" class="btn btn-primary">${doc.data().Grado}</a>
      
      </div>
      <div class="card-body">
        <p>Municipio: ${doc.data().Municipio}</p>
        <p>Localidad: <h6>${doc.data().Region}</h6></p> 
        <p> Clave CCT: <h6>${doc.data().Clave}</h6> </p>
      </div>
      <div class="card-footer text-muted">
        Ultimo reparto registrado: <p>${doc.data().Fecha}</p>
      </div>
      </div>
...
const cargarDocumentos2 = (documentos2) => {
	if(documentos2.length > 0){
      ...
      <div class="card text-center ">
      <div class="card-header">
      <a href="Primaria.html" class="btn btn-primary">${doc.data().Grado}</a>
...
const cargarDocumentos3 = (documentos3) => {
	if(documentos3.length > 0){
      ...
      <div class="card text-center ">
      <div class="card-header">
      <a href="Secundaria.html" class="btn btn-primary">${doc.data().Grado}</a>
